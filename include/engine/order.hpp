...
using Bids = std::map<Ticks, std::list<Order>,
                      std::greater<Ticks>>;  // Map of list of bids for each price point, descending
using Asks =
    std::map<Ticks, std::list<Order>>;  // Map of list of asks for each price point, ascending
